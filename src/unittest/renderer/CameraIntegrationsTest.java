...
public class CameraIntegrationsTest {
    ...
    void testIntersectionsRaySphere() {
        ...
        assertEquals(0, countIntersectionsCameraGeometry(camera1, 3, 3,
                        new Sphere(0.4, new Point(0, 0, 1))),
        ...
        assertEquals(9, countIntersectionsCameraGeometry(camera1, 3, 3,
        ...
        assertEquals(18, countIntersectionsCameraGeometry(camera4, 3, 3,
        ...
        assertEquals(10, countIntersectionsCameraGeometry(camera4, 3, 3,
    ...
    void testIntersectionsRayPlane() {
        ...
        assertEquals(6, countIntersectionsCameraGeometry(camera1, 3, 3,
    ...
    void testIntersectionsRayTriangle() throws Exception {
        ...
        assertEquals(1, countIntersectionsCameraGeometry(camera1, 3, 3,
